...
public class ViewModelo extends JInternalFrame implements ActionListener {
    ...
    private void init() {
        ...
        panelPesquisaMID.add(scroll, BorderLayout.CENTER);
    ...
    protected void setTable(String[] colunas) {
        boolean[] myBooleans = new boolean[colunas.length];
